          ...
          <div className="max-w-6xl w-full flex justify-between items-center">
            <div className="flex flex-col md:flex-row w-full justify-between px-8 md:px-0 min-h-[30vw]">
              <div className="flex flex-col w-full md:w-[60%]">
                ...
                <div className="grid w-full auto-rows-auto grid-cols-[repeat(auto-fit,_140px)] justify-center md:justify-start gap-2 md:grid-cols-[repeat(auto-fit,240px)] md:gap-8">
                  {items.map(product => (
              ...
              {items.length !== 0 && (
                <div className="flex flex-col h-fit p-4 bg-white w-full md:w-[30%] rounded-lg shadow-lg">
